<x-layouts.app :title="__('Add Device')">
    <div class="flex h-full w-full flex-1 flex-col gap-4 rounded-xl max-w-4xl mx-auto">
        ...
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-semibold text-zinc-900 dark:text-zinc-100">Add New Device</h1>
                <p class="text-sm text-zinc-600 dark:text-zinc-400">Register a new IoT device</p>
            </div>
